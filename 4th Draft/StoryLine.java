...
public class StoryLine {
    ...
    public void secondNarration(){
        simulateTyping("""
            \t\t\tHer mind raced with thoughts of escape, unaware that the path ahead would
            \t\tunveil deeper layers of the game and the trials that awaited in the next kingdom, 
            \t\tSI IT YOU?.\n
            \t\tBefore reaching the gates of SI IT YOU?, Kamadan discovered a sari-sari store, a 
            \t\tbeloved spot for local students. The store owner, Chizmosa, informed her that only 
            \t\tthose who demonstrated their coding skills could advance, as two generals guarded 
            \t\tthe path ahead. As a reward, Kamadan unlocked a new character, “Altreia,” to assist 
            \t\ther on her journey. To enter SI IT YOU?, she needed to input her ID number before
            \t\tentering the next kingdom.\n
        """);
    }

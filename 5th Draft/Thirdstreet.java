...
public class ThirdStreet extends Kingdom {
    ...
    // Local simulateTyping method for typing effect
    private void simulateTyping(String message) {
        for (char c : message.toCharArray()) {
            System.out.print(c);
            try {
                Thread.sleep(10); // Delay of 10 milliseconds between each character
    ...
    @Override
    public void enter() {
        simulateTyping("\t\t\t\tWelcome to " + name + ", the land of coding challenges!");
    }
